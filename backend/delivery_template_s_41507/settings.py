"""
Django settings for delivery_template_s_41507 project.
...
ROOT_URLCONF = 'delivery_template_s_41507.urls'
...
WSGI_APPLICATION = 'delivery_template_s_41507.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delivery_template_s_41507 API",
    "DESCRIPTION": "API documentation for delivery_template_s_41507 App",
    "VERSION": "v1",
}

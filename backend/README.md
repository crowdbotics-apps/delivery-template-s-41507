...
## Project Structure
    ...
    ├── delivery_template_s_41507  # Django project configurations
...
1. Clone this repo and `cd delivery_template_s_41507`
...
2. Clone this repo and `cd delivery_template_s_41507`
